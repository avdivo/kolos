...
Revision ID: 27ec88ef844d
Revises: 
Create Date: 2024-12-22 17:23:55.220377
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_points_type'), 'points', ['type'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_table('links')
    op.drop_index(op.f('ix_points_type'), table_name='points')
